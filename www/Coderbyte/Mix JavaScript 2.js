...
//   let startHour = parseInt(start.slice(0, start.indexOf(":"))) + 12;
//   console.log(startHour);

//   if (startAmPm == "am") {
//     startHour = parseInt(start.slice(0, start.indexOf(":")));
//   } else {
//     parseInt(start.slice(0, start.indexOf(":"))) + 12;
//   }
...
//   console.log(`${finishHour}:${finishMinutes}`);
...
//   } else {
//     if (totalStartMinutes < totalFinishMinutes) {
//       result = 1440 + totalFinishMinutes - totalStartMinutes;
//     } else {
//       result = 1440 - Math.abs(totalFinishMinutes - totalStartMinutes);
//     }
//   }
